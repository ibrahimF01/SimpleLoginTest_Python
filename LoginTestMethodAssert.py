...
message = loginTest("richfield.edu", "ibrahimF", "negative")
assert "Invalid username or password" in message

# Negative login test2:
message = loginTest("ibrahimF", "Richfield2020!", "negative")
assert "Invalid username or password" in message

# Pozitif login test:
message = loginTest("richfield.edu", "Richfield2020!", "positive")
